...
dir=${dir}_${criterion}_${criterion_unsup}_unsupscale$(echo $learning_rate_scales | awk '{printf $2}')
...
if [ ! -f $dir/.done ]; then
  steps/nnet2/train_discriminative_semisupervised2.sh \
    --criterion $criterion --criterion-unsup $criterion_unsup \
